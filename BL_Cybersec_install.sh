...
sudo rm BL_Cybersec_update_5.sh
sudo rm BL_Cybersec_update_6.sh
...
sudo wget https://raw.githubusercontent.com/Brilliant-Labs/BL-PI-cybersecurity/main/BL_Cybersec_update_5.sh
sudo wget https://raw.githubusercontent.com/Brilliant-Labs/BL-PI-cybersecurity/main/BL_Cybersec_update_6.sh
...
sudo chmod +x BL_Cybersec_update_5.sh
sudo chmod +x BL_Cybersec_update_6.sh
